      ...
      {mode === "quick" ? (
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3 min-w-0">
          <select
            ...
            className="flex-1 min-w-0 sm:flex-initial px-3 sm:px-4 py-2.5 rounded-2xl bg-white/[0.06] border border-white/[0.08] text-white text-sm min-w-[120px] sm:min-w-[140px] focus:border-white/20 focus:outline-none"
          >
